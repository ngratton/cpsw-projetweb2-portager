<template>
    ...
    <div class="container-fluid" id="profilPotager">
        ...
        <div class="row" id="creationPotager">
            <div class="col-4" id="formulairePotager">
                <form>
                    <div class="form-row">
                        <div class="col">
                    ...
                    <div class="form-row" id="trouver">
                        ...
                        <div class="col-md-5">
                            <button type="button" input type="file" id="photo" class="btn btn-primary mt-4">Trouver</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-3 ml-5" id="profilPotagerImages">
                ...
                <img src="../images/potager_pardefault_100px.png">
                <img src="../images/potager_pardefault_100px.png">
                <button type="button" input type="file" id="photo" class="btn btn-primary mr-4">Téléverser une photo</button>
            </div>
